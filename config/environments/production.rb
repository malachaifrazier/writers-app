Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "rails5-starter-app_#{Rails.env}"
  ...
  config.middleware.use ExceptionNotification::Rack,
    email: {
      email_prefix: "[Production Errors] ",
      sender_address: %{"notifier" <Figaro.env.super_email>},
      exception_recipients: %w{Figaro.env.super_email}
    }
end
